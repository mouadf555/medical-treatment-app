...
## Démonstration vidéo
Une courte vidéo présente le fonctionnement de l'application : gestion des patients, suivi des traitements et navigation dans l'interface JavaFX.

🎥 [Regarder la vidéo de démonstration](https://drive.google.com/file/d/1JHmnEoNXNku9UrxYYRjwjg0F9vjCBEXp/view?usp=sharing)

---

## Rapport
Le rapport complet du projet (analyse, conception, diagrammes UML) est disponible ici :

📄 [Consulter le rapport (PDF)](https://drive.google.com/file/d/1EkRA91xI4uQRouff2lbPDm9WZsHbuo7S/view?usp=sharing)
